...
// Warning: Profiling names must be consecutive starting from NAME_PROFILEMIN
#define NAME_PROFILEMIN ((EName)200)
#define NAME_PROFILEMAX ((EName)234)

// Profiling Names (must be consecutive starting with 
REGISTER_NAME( 200, Rune				)
REGISTER_NAME( 201, Render				)
REGISTER_NAME( 202, Think				)
REGISTER_NAME( 203, Unused				)//unused
REGISTER_NAME( 204,	DrawSkeletalMesh	)
REGISTER_NAME( 205, DrawWorld			)
REGISTER_NAME( 206, GetFrame			)
REGISTER_NAME( 207, Audio				)
REGISTER_NAME( 208, StaticTick			)
REGISTER_NAME( 209, CacheTick			)
REGISTER_NAME( 210, LevelTick			)
REGISTER_NAME( 211, Ticks				)
REGISTER_NAME( 212, DecompressAnim		)
REGISTER_NAME( 213, Decimate			)
REGISTER_NAME( 214, JointInterp			)
REGISTER_NAME( 215, JointDynamics		)
REGISTER_NAME( 216, SetAnimFrame		)
REGISTER_NAME( 217, Deform				)
REGISTER_NAME( 218, SkelSetup			)
REGISTER_NAME( 219, SkelLight			)
REGISTER_NAME( 220, SkelDrawTris		)
REGISTER_NAME( 221, SweepActors			)
REGISTER_NAME( 222, DrawShadows			)
REGISTER_NAME( 223, Optics				)
REGISTER_NAME( 224, OccludeFrame		)
REGISTER_NAME( 225, DrawFrame			)
REGISTER_NAME( 226, RenderEverything	)
REGISTER_NAME( 227, SetupDynamics		)
REGISTER_NAME( 228, DrawSprite			)
REGISTER_NAME( 229, DrawParticles		)
REGISTER_NAME( 230, ActorAnimate		)
REGISTER_NAME( 231, DynamicSkeleton		)
REGISTER_NAME( 232, ParticleSystem		)
REGISTER_NAME( 233, ScriptCode			)
REGISTER_NAME( 234, Physics				)

REGISTER_NAME( 297, Orders				)
REGISTER_NAME( 298, TriggerOrders		)
REGISTER_NAME( 299, AlertOrders			)
// warning: when adding: bump NAME_PROFILEMAX
// warning: don't go beyond 299 probe messages are there
