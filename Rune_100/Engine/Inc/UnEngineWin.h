...
class WConfigPageDetail : public WWizardPage
{
	...
	void OnInitDialog()
	{
		...
		// Sound quality.
		if( !GIsMMX || GPhysicalMemory < 128*1024*1024 )
		{
...
//			GConfig->SetString( TEXT("Botpack.TournamentPlayer"),    TEXT("bNoVoiceTaunts"),  TEXT("true") );
		...
		// Skins.
		if( (GPhysicalMemory < 128*1024*1024)/* || (DescFlags&RDDESCF_LowDetailSkins)*/ )
		{
		...
		else if (GPhysicalMemory < 256*1024*1024)
		{
		...
		// World.
		if( (GPhysicalMemory < 128*1024*1024)/* || (DescFlags&RDDESCF_LowDetailWorld)*/ )
		{
