...
struct FSurfaceInfo
{
	...
	FLOAT			FogDistance;	// RUNE:  Zone fog distance (zero if none)
//	FColor			FogColor;		// RUNE:  Zone fog color
	FPlane			FogColor;		// RUNE:  Zone fog color
};
...
// RUNE:  Definition for a surface that has fog
struct FFogSurf
{
	FSavedPoly *Polys;
	FLOAT		FogDistance;	// RUNE:  Zone fog distance (zero if none)
