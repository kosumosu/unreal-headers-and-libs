...
class ENGINE_API URenderDevice : public USubsystem
{
	...
	// RUNE
//	virtual void PreDrawGouraud(FSceneNode *Frame, FLOAT FogDistance, FColor FogColor) {}
	...
	virtual void DrawShadowSurface(FSceneNode *Frame, FTransTexture **Pts, int NumPts, FTextureInfo &Info) {};
	virtual void DrawParticleSystem(FSceneNode* Frame, FTextureInfo &Info, AParticleSystem *System) {};
